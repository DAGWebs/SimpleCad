								...
								<ul class="nav nav-main">
									...
									<li class="nav-parent">
										...
										<ul class="nav nav-children">
											<li>
												<a href="<?php echo PROOT ?>dashboard/new_product">
													 New Product
												</a>
											</li>
											<li>
									...
									<li class="nav-parent">
										...
										<ul class="nav nav-children">
											...
											<?php  
											if(Session::get('rank') == 'Administrator' || Session::get('rank') == 'Manager' || Session::get('rank') == 'Support Agent' || Session::get('rank') == 'Support Manager') {
												echo '<li>
														<a href="layouts-menu-collapsed.html">
															 View Tickets
														</a>
											...
											if(Session::get('rank') == 'Administrator' || Session::get('rank') == 'Manager' || Session::get('rank') == 'Support Manager') {
												echo '<li>
														<a href="layouts-menu-collapsed.html">
															 Support Managment
														</a>
									...
									<?php  
										if(Session::get('rank') == 'Administrator' || Session::get('rank') == 'Manager') {
											echo '	
													<li class="nav-parent">
														<a>
